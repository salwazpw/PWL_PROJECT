                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="No. Kamar" name="id" required value="{{$kamar->id}}">
                          </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" aria-describedby="emailHelp" placeholder="Foto Kamar" name="foto_kamar" required value="{{$kamar->foto_kamar}}"><br>
