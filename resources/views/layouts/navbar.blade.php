                  ...
                  <ul class="navbar-nav float-right">
                      ...
                      <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                              ...
                              <img src="{{asset('templatee/assets/images/users/admin.png')}}" alt="user" class="rounded-circle" width="40">
                              @else
                              <img src="{{asset('templatee/assets/images/users/user.png')}}" alt="user" class="rounded-circle" width="40">
                              @endif
                              <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> {{auth()->user()->username}}<span
